...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h5 class="content-title mb-0 my-auto"> إدارة النظام المحاسبي </h5><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                      ...
                      ?>
                        <form action="{{route('Restrictions.store')}}" method="POST"
                            ...
                            <div class="col">
                                ...
                                <input required type="text" readonly value="{{ $nextInvoiceNumber}}" name="Constraint_number"
                                    class="form-control" title="يرجي ادخال إسم الحساب" required>
                            </div>
                                <div class="col">
                                    <label>  الحساب</label>
                                    <select wire:model="selectedState" required name="account" class="form-control">
                                ...
                                <div class="col">
                                    <label for="inputName" class="control-label">  نوع الرصيد</label>
                                    <select required name="id_page" class="form-control">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input required type="date" name="date" value="<?php echo date('Y-m-d'); ?>" class="form-control"
                                        title="يرجي ادخال التاريخ" required>
                                </div>
                            </div>
                            </br>
