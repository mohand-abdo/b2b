<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
                ...
                <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input class="form-control" wire:model="invoice_Date" value="{{$invoice_Date}}" name="invoice_Date"   required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <input required wire:model="unit_id" name="unit_id" readonly type="text" placeholder="الوحدة" class="form-control">
                        </div>

                        <div class="col-md-2">
                            <label for="inputName" class="control-label"> سعر الوحدة</label>
                            <input required wire:model="price" name="price"  type="number" placeholder="سعر الوحدة" class="form-control">
                        </div>
                        <div class="col-md-2">
                            <label for="inputName" class="control-label">  الكمية</label>
                            <input required wire:model="amount" name="amount" type="number" placeholder="الكمية" class="form-control">
                        </div>
                        <div class="col-md-2">
                            <label for="inputName" class="control-label">  &nbsp;</label>
                            <button type="submit" onclick="event.preventDefault()"  wire:click="add()" class="btn btn-primary btn-block"> <i class="fa fa-plus"> </i></i></button>
                        </div>
                    </form>
                    </div>
                </br>
            ...
            <table  class="table table-hover mb-0 text-md-nowrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-danger" wire:click="deletItem({{$item->id}})"><i class="fa fa-trash"></i> </button>
                        </td>
                    </tr>
                @endforeach
                </tbody>
        ...
        @else
            <p>لا يوجد أصناف بالفاتورة حاليا</p>
        @endif
                    <br>

                    <div class="d-flex justify-content-center">
                        <button onclick="event.preventDefault()"  wire:click="add_purchase()" class="btn btn-primary">حفظ الفاتورة</button>
                    </div>
