        ...
        <div class="my-auto">
            <div class="d-flex">
                <h5 class="content-title mb-0 my-auto"> إدارة النظام المحاسبي </h5><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ القيود اليومية</span>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('Operation.store') }}" method="POST"
                                ...
                                <div class="col">
                                    ...
                                    <input required type="hidden" value="{{ $nextInvoiceNumber }}"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <span class="tx-danger">*</span><label>البيان</label>
