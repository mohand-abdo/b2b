                ...
                <div class="card-header pb-0">
                    ...
                    @can('إضافة نشاط')
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card-body">
                                <form action="{{ route('tree2.store') }}" method="POST"
                                    class="form-horizontal form-label-left">
                                    @csrf
                                    <div class="row">
                                        <div class="col">
                                            <span class="tx-danger">*</span><label> الحساب الرئيسي</label>
                                            <select required name="tree1_code" class="form-control select2">
                                        ...
                                        <div class="col">
                                            <span class="tx-danger">*</span><label for="inputName" class="control-label"> إسم
                                                الحساب</label>
                                            <input type="text" name="tree2_name" class="form-control"
                                        ...
                                        <td>
                                            @can('تعديل نشاط')
                                                <a class="modal-effect btn btn-outline-success btn-sm"
                                                    ...
                                                    data-id="{{ $tree->id }}"
                                                    data-tree1_name="{{ $tree->tree1->tree1_name }}"
                                                    data-tree2_code="{{ $tree->tree2_code }}"
