...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h5 class="content-title mb-0 my-auto"> إدارة النظام المحاسبي </h5><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تقرير قيد يومية</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <table class="table text-md-nowrap" id="example1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$item->date}}</td>
                                <td>
                                <a class="btn btn-outline-success btn-sm" href="Print_Daily/{{$item->id}}" title="عرض"><i class="fa fa-edit"></i>&nbsp;&nbsp;عرض </i></a
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
