            ...
            <div class="card-header pb-0">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card-body">
                        ...
                        ?>
                        <form action="{{route('Vehicle.store')}}" method="POST" class="form-horizontal form-label-left">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <select wire:model="selectedState" required name="account_one" class="form-control">
                                ...
                                <div class="col">
                                    ...
                                    <input required id="one" onkeyup="vat()"  type="number" name="price_one" class="form-control"
                                        title="يرجي ادخال  المبلغ" required>
                                </div>
                            </div>
                            </br>
                            {{-- first row in the mult restraction --}}
                            ...
                            <div class="row">
                                <div class="col">
                                    {{-- <label>الحساب</label> --}}
                                    <select wire:model="selectedState" required name="account_tow" class="form-control">
                                        <option value="">اختر حساب </option>
                                        @foreach ($tree4 as $tree)
                                        <option value="{{$tree->tree4_code}}">{{$tree->tree4_name}}</option>
                                        @endforeach
                                ...
                                <div class="col">
                                    {{-- <label for="inputName" class="control-label"> المبلغ</label> --}}
                                    <input required type="number" id="tow" value="0"  name="price_tow" onkeyup="vat()" class="form-control"
                                        title="يرجي ادخال  المبلغ" required>
                                </div>
                            </div>
                            {{-- tow row in the mult restraction --}}
                            ...
                            <div class="row">
                                <div class="col">
                                    {{-- <label>الحساب</label> --}}
                                    <select wire:model="selectedState" name="account_three" class="form-control">
                                        <option value="">اختر حساب </option>
                                        @foreach ($tree4 as $tree)
                                        <option value="{{$tree->tree4_code}}">{{$tree->tree4_name}}</option>
                                        @endforeach
                                ...
                                <div class="col">
                                    {{-- <label for="inputName" class="control-label"> المبلغ</label> --}}
                                    <input required type="number" id="three" onkeyup="vat()" value="0" name="price_three"
                                        class="form-control" title="يرجي ادخال  المبلغ">
                                </div>
                            </div>
                            {{-- tow row in the mult restraction --}}
                            </br>
                                    ...
                                    <ul id="treeview1">
                                        <li><a href="#">اَخـري</a>
                                            <ul>
                                                <div class="col-md-6">
                                                    {{-- <label>الحساب</label> --}}
                                                    <select wire:model="selectedState" name="account_four"
                                                        class="form-control">
                                                        <option value="">اختر حساب </option>
                                                        @foreach ($tree4 as $tree)
                                                        <option value="{{$tree->tree4_code}}">{{$tree->tree4_name}}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <ul>
                                                <div class="col-md-6">
                                                    {{-- <label for="inputName" class="control-label"> المبلغ</label>
                                                    --}}
                                                    <input type="number" onkeyup="vat()" id="four" value="0" name="price_four"
                                                        class="form-control" title="يرجي ادخال  المبلغ">
                                                </div>
                                            </ul>
                                            &nbsp;
                                            <ul>
                                                <div class="col-md-6">
                                                    {{-- <label>الحساب</label> --}}
                                                    <select wire:model="selectedState" name="account_five"
                                                        class="form-control">
                                                        <option value="">اختر حساب </option>
                                                        @foreach ($tree4 as $tree)
                                                        <option value="{{$tree->tree4_code}}">{{$tree->tree4_name}}
                                            ...
                                            <ul>
                                                <div class="col-md-6">
                                                    {{-- <label for="inputName" class="control-label"> المبلغ</label>
                                                    --}}
                                                    <input type="number" onkeyup="vat()" id="five" value="0" name="price_five"
                                                        class="form-control" title="يرجي ادخال  المبلغ">
                                                </div>
                                            </ul>
                                            &nbsp;
                                            <ul>
                                                <div class="col-md-6">
                                                    {{-- <label>الحساب</label> --}}
                                                    <select wire:model="selectedState" name="account_six"
                                                        class="form-control">
                                                        <option value="">اختر حساب </option>
                                                        @foreach ($tree4 as $tree)
                                                        <option value="{{$tree->tree4_code}}">{{$tree->tree4_name}}
                                            ...
                                            <ul>
                                                <div class="col-md-6">
                                                    {{-- <label for="inputName" class="control-label"> المبلغ</label>
                                                    --}}
                                                    <input type="number" onkeyup="vat()" id="six" value="0" name="price_six"
                                                        class="form-control" title="يرجي ادخال  المبلغ">
                                                </div>
                                            </ul>
                                        </li>
                            ...
                            <div class="d-flex justify-content-center">
                                <button type="submit" id="saveButton" class="btn btn-primary"> إضــافة القيد</button>
                            </div>
                        </form>
                    </div>
                </div>
