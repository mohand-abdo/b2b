...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">تفاصيل {{ $tree->type == 'حاج' ? 'الحاج' : 'المعتمر' }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ عرض تفاصيل</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="row row-sm">
        <div class="col-md-12 col-xl-12">
            <div class="card card-invoice">
                <div class="card-body">
                    <h4 class="invoice-title">تفاصيل {{ $tree->type == 'حاج' ? 'الحاج' : 'المعتمر' }}</h4>
                    <br>
