...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h5 class="content-title mb-0 my-auto"> إدارة الحجاج </h5>
            <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ دفعيات الحجاج</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <table class="table text-md-nowrap" id="example1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$item->date}}</td>
                                <td>
                                    <a class="btn btn-outline-success btn-sm" href="client-print/{{ $item->id}}" title="طباعة">
                                        <i class="fa fa-print">
                                        </i>&nbsp;&nbsp;طباعة السند </i></a>
