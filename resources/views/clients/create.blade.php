                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="type" id="type" class="form-control" required>
                                            ...
                                            <option value="حاج" {{ old('type') == 'حاج' ? 'selected' : ''}}>حاج</option>
                                            <option value="معتمر" {{ old('type') == 'معتمر' ? 'selected' : ''}}>معتمر</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="nationalty" type="text" name="nationalty" class="form-control" value="{{ old('nationalty') }}" required>
                                    </div>
                                </div>
                            </div>
                            </br>
