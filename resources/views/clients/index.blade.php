...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h5 class="content-title mb-0 my-auto"> الحجاج </h5><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ كشف حساب حاج </span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex">
                    <h5 class="content-title mb-0 my-auto"> كشف حساب حاج:</h5>
                </div>
