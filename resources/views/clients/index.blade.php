...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h5 class="content-title mb-0 my-auto"> الحجاج والمعتمرين </h5><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    كشف حساب حاج او معتمر </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex">
                        <h5 class="content-title mb-0 my-auto"> كشف حساب حاج او معتمر:</h5>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="card-body">
                            <form method="POST" action="{{ route('client_statement.show') }}" id="demo-form2"
                                class="form-horizontal form-label-left">
                                @csrf
                                <div class="row">
                                    <div class="col">
                                        <div class="alert alert-primary" role="alert">
                                            اَختر الحساب مع تحديد الفترة من تاريخ البداية الي تاريخ النهاية لكي يتم عرض
                                            تفاصيل الحساب خلال الفترة المحددة .
                                            <span class="alert-inner--icon"><i class="ti-bell"></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <span class="tx-danger">*</span><label> الحســاب
                                    </label>
