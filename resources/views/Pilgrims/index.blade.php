...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h5 class="content-title mb-0 my-auto">  الحجاج</h5><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    قائمة الحجاج</span>
            </div>
        </div>
    </div>
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-20p border-bottom-0">رقم البطاقة او الهوية </th>
                                    ...
                                    <th class="wd-15p border-bottom-0"> عدد العقود </th>
                                    ...
                                    <tr data-id="{{ $stage->id }}">
                                        ...
                                        <td>
                                            ...
                                            <a class="modal-effect btn btn-outline-info btn-sm"
                                                ...
                                                data-stage="{{ $stage->stage }}" title="عرض">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <select id="campaign_id" name="campaign_id" class="form-control" required>
                                    <option value="">اختر الحملة</option>
                                    @php
                                        $campaigns = \App\Models\Campaigns::all();
                                    @endphp
                                    @foreach ($campaigns as $campaign)
                                        <option value="{{ $campaign->id }}">{{ $campaign->name }}</option>
                                    @endforeach
