...
@section('title')
    تسجيل الدخول - براند سوفت للادارة القانونية
@stop
                                ...
                                <div class="card-sigin">
                                    ...
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            <h2>مرحبــــاً بك</h2>
                                            <h5 class="font-weight-semibold mb-4"> تـسجيل الـدخول</h5>
                                            <form method="POST" action="{{ route('login') }}">
                                                @csrf
                                                <div class="form-group">
                                                    <label>البريد الالكتروني او رقم التلفون</label>
                                                    <input id="email" type="test"
                                                ...
                                                <div class="register-link">
                                                    <p>ليس لديك حساب؟</p>
                                                    <a href="{{ url('register') }}" class="btn-register">تسجيل</a>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
