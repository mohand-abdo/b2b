    ...
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">  تقارير الفواتير  </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                 تقرير الفواتير حسب العميل </span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex">
                    <h5 class="content-title mb-0 my-auto">تقرير الفواتير حسب العميل   :</h5>
                </div>
                <div class="col-lg-12 col-md-12">
                    <div class="card-body">
                        <form method="POST" action="{{ route('client_report.show')}}" id="demo-form2"
                            class="form-horizontal form-label-left">
                            @csrf
                            <div class="row">
                                <div class="col">
                                    <div class="alert alert-primary" role="alert">
                                        اختر العميل مع تحديد الفترة ليتم عرض تقرير مفصل للعميل خلال الفترة المحددة 
                            ...
                            <div class="d-flex justify-content-center">
                                <button type="submit" class="btn btn-primary"> عــرض</button>
                            </div>
                        </form>
                    </div>
                </div>
