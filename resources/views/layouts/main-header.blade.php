    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            ...
            <div class="main-header-center mr-3 d-sm-none d-md-none d-lg-block">
                {{-- <input class="form-control" placeholder="إبحث عن ماتريد ..." readonly type="search"> <button class="btn"><i class="fas fa-search d-none d-md-block"></i></button> --}}
            </div>
        </div>
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                @if (Helper::countNotifications() > 0)
                    <div class="dropdown nav-item main-header-notification">
                        <a class="new nav-link" href="#">
                            ...
                            <span class="{{ Helper::unReadCountNotifications() ? 'pulse' : '' }}"></span>
                        </a>
                        <div class="dropdown-menu" style="overflow: auto">
                            <div class="menu-header-content bg-primary text-right">
                                ...
                                <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">لديك
                                    {{ Helper::unReadCountNotifications() }}
                                    رسالة غير مقروءة</p>
                            </div>
                            <div class="main-notification-list Notification-scroll">
                                @foreach (Helper::notifications() as $notification)
                                    <a href="{{ route($notification->url,['id' => $notification->id]) }}"
                                        class="notification d-flex p-3 border-bottom {{ $notification->read == false ? 'unread' : '' }}"
                                        data-id="{{ $notification->id }}" data-url="{{ route($notification->url) }}">
                                        <div class="mr-3">
                            ...
                            {{-- <div class="dropdown-footer">
										<a  href="{{ url('/' . $page='home') }}">VIEW ALL</a>
									</div> --}}
                        </div>
                    </div>
                @endif
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ asset('image/logo/' . Helper::GeneralSiteSettings('logo')) }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt=""
                                        src="{{ asset('image/logo/' . Helper::GeneralSiteSettings('logo')) }}"
                                        class=""></div>
                        ...
                        <a class="dropdown-item" href="{{ url('/' . ($page = 'profile')) }}"><i
