...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> أنشطة الحسابات </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    المستوي الثالث</span>
            </div>
        </div>
    </div>
                ...
                <div class="card-header pb-0">
                    ...
                    @can('إضافة نشاط')
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card-body">
                                <form action="{{ route('tree3.store') }}" method="POST"
                                    class="form-horizontal form-label-left">
                                    @csrf
                                    <div class="row">
                                        <div class="col">
                                            <span class="tx-danger">*</span><label> الحساب الرئيسي</label>
                                            <select required name="tree2_code" class="form-control select2">
                                        ...
                                        <div class="col">
                                            <span class="tx-danger">*</span><label for="inputName" class="control-label"> إسم
                                                الحساب</label>
                                            <input type="text" name="tree3_name" class="form-control"
                                        ...
                                        <td>
                                            @can('تعديل نشاط')
                                                <a class="modal-effect btn btn-outline-success btn-sm"
                                                    ...
                                                    data-id="{{ $tree->id }}" data-tree3_name="{{ $tree->tree3_name }}"
                                                    data-tree3_code="{{ $tree->tree3_code }}"
                                                    data-tree2_name="{{ $tree->tree2->tree2_name }}" title="تعديل">
                                                    <i class="fa fa-edit">
                                                    </i>&nbsp;&nbsp;تعديل </i></a>
                                            @endcan
                                        </td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">تعديل إسم الحساب </h6><button aria-label="Close" class="close"
