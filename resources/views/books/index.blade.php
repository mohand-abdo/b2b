...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h5 class="content-title mb-0 my-auto"> التقارير المحاسبية </h5><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الدفاتر المحاسبية</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex">
                    <h5 class="content-title mb-0 my-auto"> تقرير  الدفاتر المحاسبية :</h5>
                </div>
                <div class="col-lg-12 col-md-12">
                    <div class="card-body">
                        <form method="POST" action="{{route('Books.show')}}" id="demo-form2" class="form-horizontal form-label-left">
                            @csrf
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="col">
                                ...
                                <select required name="tree3" class="form-control select2" ></select>
                            </div>
...
<!-- Internal Select2 js-->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('.select2').select2({
                ajax: {
                    url: "{{ route('select2.getBook') }}", // رابط البحث
                    dataType: 'json',
                    delay: 250,
