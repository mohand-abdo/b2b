...
class ContractController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $contract->tree4_id = $request->tree4_id;
        ...
        $contract->tree4_code = $contract->tree4->tree4_code;
        $contract->save();
        ...
        $operation->Madin = $contract->tree4->tree4_code;
        ...
        $restriction2->tree4_code = $contract->tree4->tree4_code;
        $restriction2->Dain = 0;
...
public function edit($id)
{
   ...
   public function update(Request $request, $id)
   {
       ...
       $restriction1 = Restrictions::where('op_id', $operation->id)->where('Madin', 0)->first();
       if (! $restriction1) {
       ...
       $restriction2 = Restrictions::where('op_id', $operation->id)->where('Dain', 0)->first();
       if (! $restriction2) {
           // Create a new Restrictions record if it doesn't exist
           $restriction2 = new Restrictions();
